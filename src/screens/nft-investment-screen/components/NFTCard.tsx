      ...
      <CardContent className="p-4">
          ...
          <div>
            ...
            <div className="text-lg font-bold">
              {totalValue !== undefined
                ? `${formatNumber(totalValue)} ETH`
                : nft?.price
                ? `${formatNumber(nft?.price)} ETH`
                : "Thương lượng"}
            </div>
          </div>
          <div className="text-right">
            ...
            <div className="text-lg font-bold">
              {pricePerShare !== undefined
                ? `${formatNumber(pricePerShare)} ETH`
                : "-"}
            </div>
          </div>
        </div>
        ...
        <div className="text-xs text-muted-foreground mb-4 flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            <span className="w-1.5 h-1.5 rounded-full bg-foreground/70 inline-block" />
            <span className="font-medium text-foreground">{purchaseCount}</span>
          </div>
        </div>
